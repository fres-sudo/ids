...
public final class Validator {
    ...
    /**
     * Validates the user deletion requests by checking if the provided email and hashed password match
     * the user's details.
     *
     * @param passwordEncoder the PasswordEncoder to use for password validation
     * @param user the user to validate against
     * @param request the deletion requests containing email and password
